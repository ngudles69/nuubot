...
2. Design:
  ...
  - `design/server.md`: Server, WebGUI, managers, CLI helper, worker ownership.
  ...
  - `design/webgui.md`: FastHTML WebGUI ownership and layout.
  - `design/dataengines.md`: optional shared websocket/feed engines.
  - `design/processpool.md`: ProcessPoolExecutor sweep worker model.
